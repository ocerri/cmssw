...
namespace DecayTreeFitter
{
  ...
  ParticleBase* ParticleBase::addDaughter(const reco::Candidate& cand, const Configuration& config)
  {
  ...
  ParticleBase*
  ParticleBase::createParticle(const reco::Candidate& particle,
  ...
  bool
  ParticleBase::isAResonance(const reco::CandidateProperty& prop) {
  ...
  const
  ParticleBase* ParticleBase::locate(const reco::Candidate& abc) const
  {
    // does there exist an 'iscloneof' in CMS?
  ...
  void ParticleBase::locate( const reco::CandidateID& pid,
