...
namespace DecayTreeFitter
{
  ...
  InternalParticle::InternalParticle(const int pdgId, ParticleBase* mother)
    : ParticleBase(pdgId,mother,0), m_lifetimeconstraint(false)
  {
  }
  ...
  InternalParticle::initPar1(FitParams* fitparams)
  {
    ...
    if( fitparams->par()(posindex+1)==0 && fitparams->par()(posindex+2)==0 && fitparams->par()(posindex+3)==0 ) {
...
----->>> Here - Implementing RecoTrack first
