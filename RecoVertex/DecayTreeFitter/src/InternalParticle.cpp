...
namespace DecayTreeFitter
{
  ...
  InternalParticle::InternalParticle(const reco::Candidate& bc, const ParticleBase* mother,
                                     const Configuration& config)
    : ParticleBase(bc,mother),m_lifetimeconstraint(false)
  {
    BOOST_FOREACH( const reco::Candidate* daughter, bc.daughters() )
  ...
  InternalParticle::initPar1(FitParams* fitparams)
  {
    ...
    // There are two ways out: If the reco::Candidate was vertexed
