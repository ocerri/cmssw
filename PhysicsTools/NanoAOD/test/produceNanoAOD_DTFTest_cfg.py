...
# process.NANOAODSIMoutput = cms.OutputModule("PoolOutputModule",   #NANOAOD edm event content
    ...
    fileName = cms.untracked.string('file:/eos/user/o/ocerri/BPhysics/data/cmsMC_private/HardQCD_bbar_Bu_D0munu_KPimunu_NoPU_10-2-3_v0/HardQCD_bbar_Bu_D0munu_KPimunu_NANOAODSIM_DTFtest.root'),
...
process.load('PhysicsTools.NanoAOD.DecayTreeFitterTrial_cff')
process.nanoSequenceMC.insert(-1, process.DecayTreeFitterTrialSequence)
