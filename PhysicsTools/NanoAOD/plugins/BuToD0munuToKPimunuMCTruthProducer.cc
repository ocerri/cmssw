...
vector<int> BuToD0munuToKPimunuMCTruthProducer::RecoMC_matching(edm::Handle<edm::View<reco::Candidate>> reco_handle, reco::Candidate * pg) {
...
vector<int> BuToD0munuToKPimunuMCTruthProducer::RecoMC_matching(edm::Handle<edm::View<reco::Candidate>> reco_handle, pat::PackedGenParticle* pg) {
  double max_DeltaR = 0.01;
  double max_Delta_pt_rel = 0.05;
